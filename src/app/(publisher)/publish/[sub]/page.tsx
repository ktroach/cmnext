...
import { CalendarDateRangePicker } from '@/app/(publisher)/publish/[sub]/dashboard/date-range-picker'
import { Overview } from '@/app/(publisher)/publish/[sub]/dashboard/overview'
import { RecentSales } from '@/app/(publisher)/publish/[sub]/dashboard/recent-sales'
...
import { ViewWebsite } from '@/components/publisher/view-website'
      ...
      <div className="hidden flex-col md:flex">
        <div className="flex-1 space-y-4 p-8 pt-6">
          <div className="flex items-center justify-between space-y-2">
            ...
            <ViewWebsite subRef={params?.sub} subsiteData={subsiteData} />
          </div>
