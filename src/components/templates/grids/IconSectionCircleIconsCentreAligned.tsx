import { BookOpenIcon, MessagesSquareIcon, Settings2Icon } from 'lucide-react'

export interface IconSectionCircleIconsCentreAlignedProps {
  children?: any
}

export default function IconSectionCircleIconsCentreAligned({
  children,
}: IconSectionCircleIconsCentreAlignedProps) {
  return (
    <>
      {/* Icon Blocks */}
